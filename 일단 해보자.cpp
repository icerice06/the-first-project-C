...
int main(){           //main함수의 역할은 비교 
	...
	if(b=='x')        //결제 취소  모든 변수 배열 초기화 배열은 가겨 뺴고 
	{
	...
	if(a==1){       //버거 화면에서 카운트 
		switch(b){
			case '1':qjrj[1][0]++;
			break;
			case '2':qjrj[1][1]++;        //0번째 줄은 가격 이기 떄문에 0줄 가격 바로 밑에 카운트 
			break;
			case '3':qjrj[1][2]++;
			break;
			case '4':qjrj[1][3]++;
	...
	if(a==2){       //사이드 화면에서 카운트 
		switch(b){
			case '1':tkdlem[1][0]++;
			break;
			case '2':tkdlem[1][1]++;       //0번째 줄은 가격 이기 떄문에 0줄 가격 바로 밑에 카운트 
			break;
			case '3':tkdlem[1][2]++;
			break;
			case '4':tkdlem[1][3]++;
	...
	if(a==3){        //음료 화면에서 카운터
		switch(b){
			...
			case '2':dmafy[1][1]++;
			break;
			case '3':dmafy[1][2]++;     //0번째 줄은 가격 이기 떄문에 0줄 가격 바로 밑에 카운트 
			break;
			case '4':dmafy[1][3]++;
			break;
			case '5':dmafy[1][4]++;
